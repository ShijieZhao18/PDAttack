...
parser.add_argument('--images_root', default="dataset/images", type=str,
                    help='The clean images root directory')
parser.add_argument('--label_path', default="dataset/labels.txt", type=str,
...
parser.add_argument('--pretrained_diffusion_path',
                    ...
                    type=str,
                    help='Change the path to `stabilityai/stable-diffusion-2-1-base` if want to use the pretrained model')
...
parser.add_argument('--is_hard_mask', default=False, type=bool,
                    help='Which type of mask to leverage')
...
def run_diffusion_attack(image, label, diffusion_model, diffusion_steps, guidance=2.5,
                         ...
                         model_name="resnet", start_step=15, iterations=30, args=None):
    controller = AttentionControlEdit(diffusion_steps, self_replace_steps, args.res)

    adv_image, clean_acc, adv_acc = prompt_attack.diffattack(diffusion_model, label, controller,
...
if __name__ == "__main__":
    ...
    # Change the path to "stabilityai/stable-diffusion-2-1-base" if you want to use the pretrained model.
    ...
    if is_test:
        ...
        """
                Test the robustness of the generated adversarial examples across a variety of normally trained models or adversarially trained models.
        """
